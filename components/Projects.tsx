...
const Projects: React.FC<Props> = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className="h-screen relative flex overflow-hidden flex-col test-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0"
    >
        ...
        {projects.map((project, i) => (
          ...
          >
            <motion.img
              ...
              viewport={{ once: true }}
              className="w-full h-full object-cover border border-gray-500 rounded-sm"
